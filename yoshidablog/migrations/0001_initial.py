# Generated by Django 3.1.2 on 2021-02-01 05:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='yoshidablog.category', verbose_name='カテゴリ')),
            ],
            options={
                'ordering': ('-created_at',),
            },
